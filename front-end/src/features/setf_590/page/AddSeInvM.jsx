      ...
      return (
        <Grid item xs={gridSize} key={fieldName}>
          <TextField
            ...
            defaultValue="1"
          >
            <MenuItem value="1">1-小合同</MenuItem>
            <MenuItem value="2">2-大合同</MenuItem>
          </TextField>
        </Grid>
      );
    }
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={2} mb={3}>
              ...
              <Grid item xs={2.4}>
                <TextField
                  fullWidth
                  label={getColumnLabel("last_edate", "last_edate")}
                  {...register("last_edate")}
                  type="date"
                  InputLabelProps={{ shrink: true }}
                />
            ...
            {/* Row 5 */}
            <Grid container spacing={2} mb={3}>
              {renderField("insurance", "insurance", 2.4)}
