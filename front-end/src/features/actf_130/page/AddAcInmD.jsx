...
const AddAcInmD = ({
  ...
  useEffect(() => {
    if (open && selectRows && selectRows.length > 0) {
      reset({
        factory_code: user?.factory || "",
  ...
  // Reset in_unit khi item_no thay đổi
  useEffect(() => {
    if (item_no !== dropdownValues.item_no) {
      setValue("in_unit", "");
        ...
        <Paper sx={{ maxWidth: "800px", mx: "auto", p: 3 }}>
          ...
          >
            <Typography
              ...
              mb={0}
            >
              {getControlLabel("ttl_d_add", "Add Ac Inm D")}
            </Typography>
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={2} mb={3}>
              ...
              <Grid item xs={4}>
                <TextField
                  fullWidth
                  label={getColumnLabel("inm_no", "Inm No")}
                  value={(selectRows && selectRows[0]?.inm_no) || ""}
                  InputLabelProps={{ shrink: true }}
                  disabled
                />
              </Grid>
