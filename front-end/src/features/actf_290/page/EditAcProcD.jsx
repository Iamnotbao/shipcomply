...
const EditAcProcD = ({
  ...
  useEffect(() => {
    const calculatedMoney =
      Math.round((qty || 0) * (price || 0) * 10000) / 10000;
              ...
              <Dropdown
                ...
                onSelect={(selectedItem) => {
                  ...
                  const displayValue = selectedItem
                    ? `${selectedItem.ac_item || ""}-${selectedItem.item_acno || ""}-${selectedItem.itemnm || ""}-${selectedItem.unit || ""}`
                    : "";
                  ...
                  setDropdownValues((prev) => ({
                    ...prev,
                    ac_itemno: displayValue,
                    ac_itemno_save: saveValue,
                  }));
                }}
                select={dropdownValues.ac_itemno || ""}
                table="AC_ITEM_M"
                option="ac_item"
