...
const AddAcChgD = ({
  ...
  console.log("adudu", selectParentRows[0]);
  ...
  const ac_chg_d = selectRows?.[0] || {};

  useEffect(() => {
    if (open) {
      setValue("factory_code", user?.factory);
      setValue("ac_no", ac_chg_d?.ac_no || "");
    } else {
      reset();
      setDropdownValues({
        ac_itemno: "",
            ...
            render={({ field }) => (
              <Dropdown
                ...
                onSelect={(selectedItem) => {
                  ...
                  setDropdownValues((prev) => ({
                    ...prev,
                    price_cont_no: selectedItem?.cont_no || "",
                    price_seq: selectedItem?.seq || "",
                  }));
                }}
                select={{
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={2} mb={2}>
              ...
              {renderField(
                ...
                {
                  inputProps: { readOnly: true },
                  helperText: "Auto from CONT_NO & AC_ITEMNO",
                },
                "number",
              )}
            </Grid>
            ...
            <Grid container spacing={2} mb={2}>
              ...
              {renderField(
                ...
                {
                  inputProps: { readOnly: true },
                  helperText: "Auto: IN Quantity * PRICE",
                },
                "number",
              )}
              {renderField(
