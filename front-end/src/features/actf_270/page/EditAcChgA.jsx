...
const EditAcChgA = ({
  ...
  user,
  auth,
  selectRows, // AC_CHG_A data to edit
}) => {
  ...
  useEffect(() => {
    if (open && editData) {
      ...
      setValue("desc_item", editData.desc_item);
      setValue("ori", editData.ori);
      setValue("addo", editData.addo);
        ...
        <Paper sx={{ maxWidth: "800px", mx: "auto", p: 3 }}>
          ...
          >
            <Typography
              ...
              mb={0}
            >
              {getControlLabel("ttl_d_2_edit", "Edit AC_CHG_A")}
            </Typography>
            <Button
          ...
          <Box component="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={2} mb={2}>
              ...
              {renderField("seq", "Seq", 4, { disabled: true }, "number")}
            </Grid>
