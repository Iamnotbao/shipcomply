...
import { addABomM, editABomM } from "../../service/ac_bom_m/AcBomMService";
...
const Actf1101 = () => {
  ...
  const [currentAcContDPage, setCurrentAcContDPage] = useState(0);
  const [currentAcContDPageSize, SetCurrentAcContDPageSize] = useState(10);
  //========== FETCH DATA SECTION ================
  //fetch all factory
  ...
  const fetchAcContDByContNo = async () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (error.message) {
        ...
        toast.error("An error occurred while copying contract");
      }
          ...
          <Stack direction="row" flexWrap="wrap" sx={{ rowGap: 1 }}>
            ...
            >
              ...
              <AcContD
                ...
                setSelectAcInmD={setSelectAcContD}
                selectAcInmD={selectAcContD}
                jumpToRow={jumpToRowAcContD}
                setJumpToRow={setJumpToRowAcContD}
                user={user}
                handleBasicDataPageChange={handleBasicDataPageChange}
                currentAcContDPage={currentAcContDPage}
                setCurrentAcContDPage={setCurrentAcContDPage}
                currentAcContDPageSize={currentAcContDPageSize}
                SetCurrentAcContDPageSize={SetCurrentAcContDPageSize}
                searchBasicDataFilter={searchBasicDataFilter}
                fetchAcContDByContNo={fetchAcContDByContNo}
                ...
                handleAddAcInmD={handleAddAcInmD}
              />
              <VwContUse />
            </Paper>
          </Stack>
