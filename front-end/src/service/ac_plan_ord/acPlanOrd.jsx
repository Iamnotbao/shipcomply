...
const API = "/ac_plan_ord";
export const fetchAllAcPlanOrd = async (
  token,
  factory_code,
  ac_no,
  department_code,
  ...
  const response = await axios.get(
    `${API}/all?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&language=${language}&limit=${limit}&offset=${offset}&ac_no=${ac_no}`,
    {
      headers: {
