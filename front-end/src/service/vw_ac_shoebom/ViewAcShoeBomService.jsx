...
const API = "/vw_ac_shoebom";
export const fetchViewAcShoeBom = async (
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  const response = await axios.get(
    `${API}/list_of_ac_shoebom?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&limit=${limit}&offset=${offset}`,
    {
      headers: {
...
export const searchVwAcShoeBomByFilter = async (
  filtered,
  factory_code,
  department_code,
  user_code,
...
export const exportPDFVwAcShoeBom = async (
  factory_code,
  department_code,
  user_code,
  query_level
  ...
  try {
    ...
    link.href = url;
    link.setAttribute("download", "vw_ac_shoebom.xlsx");
