...
const API = "/vw_acreq_d";
export const fetchVwAcReqDByCom = async (
  factory_code,
  com_invoice,
  department_code,
  user_code,
  ...
  const response = await axios.get(
    `${API}/list_of_acreq_d?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&com_invoice=${com_invoice}&language=${language}&limit=${limit}&offset=${offset}`,
    {
      headers: {
