...
const API = "/vw_ac_chgsum";
export const fetchVwAcChgSum = async (
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  const response = await axios.get(
    `${API}/list_of_chg_sum?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&language=${language}&limit=${limit}&offset=${offset}`,
    {
      headers: {
...
export const exportExcelOutVwAcChgSum = async (
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  try {
    const response = await axios.post(
      `${API}/out_excel?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&language=${language}`,
      { filters: filters },
      {
        responseType: "blob",
      },
    ...
    const link = document.createElement("a");
    link.href = url;
    link.setAttribute("download", "vw_ac_chgsum_out.xlsx");
    document.body.appendChild(link);
    link.click();
    link.remove();
  } catch (error) {
