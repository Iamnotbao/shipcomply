...
export const fetchAllAcDescChgByAcno = async (
  factory_code,
  ac_no,
  department_code,
  user_code,
...
export const fetchAcDescChgByID = async (factory_code, ac_no, seq) => {
  const response = await axios.get(
...
export const addAcDescChg = async (
  token,
  factory_code,
  department_code,
  user_code,
...
export const editAcDescChg = async (
  token,
  factory_code,
  department_code,
  user_code,
