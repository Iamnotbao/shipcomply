...
const API = "/se_plan_ord";
export const fetchAllSePlanOrd = async (
  token,
  factory_code,
  department_code,
  user_code,
...
export const fetchAllSePlanOrdLink = async (
  token,
  factory_code,
  department_code,
  user_code,
...
export const fetchSePlanOrdByID = async (
  token,
  factory_code,
  se_id,
  se_ver,
...
export const confirmItemsSePlanOrd = async (
  factory_code,
  department_code,
  user_code,
  query_level,
...
export const unconfirmItemsSePlanOrd = async (
  factory_code,
  department_code,
  user_code,
  query_level,
...
export const editSePlanOrd = async (
  token,
  factory_code,
  department_code,
  user_code,
  ...
  const response = await axios.put(
    `${API}/edit?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&se_id=${data.se_id}&se_ver=${data.se_ver}&se_seq=${data.se_seq}&ship_seq=${data.ship_seq}&pack_gu=${data.pack_gu}&page_size=${pageSize}`,
    { data: data },
    {
      headers: {
        authorization: `Bearer ${token}`,
...
export const fetchMoneyBySeId = async (
  factory_code,
  se_id,
  department_code,
  user_code,
  ...
  const response = await axios.get(
    `${API}/money?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&se_id=${se_id}`,
    {
      headers: {
        "ngrok-skip-browser-warning": "true",
      },
