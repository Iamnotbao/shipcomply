...
export const fetchAllADPByAcno = async (
  factory_code,
  ac_no,
  department_code,
  user_code,
...
export const fetchADPByID = async (factory_code, ac_no, seq) => {
  const response = await axios.get(
