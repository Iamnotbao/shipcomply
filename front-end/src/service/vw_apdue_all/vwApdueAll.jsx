...
const API = "/vw_apdue_all";
export const fetchViewVApA = async (
    vend_no,
    com_invoice,
    col6,
    col4,
  ...
  const response = await axios.get(
    `${API}/list_of_proc_m?vend_no=${vend_no}&com_invoice=${com_invoice}&col6=${col6}&col4=${col4}&language=${language}&limit=${limit}&offset=${offset}`,
    {
      headers: {
...
export const exportExcelVwApDueAll = async (
  factory_code,
  department_code,
  user_code,
  query_level,
