...
export const fetchAllAcChgAByAcno = async (
  factory_code,
  ac_no,
  department_code,
  user_code,
...
export const fetchAcChgAByID = async (factory_code, ac_no, seq) => {
  const response = await axios.get(
