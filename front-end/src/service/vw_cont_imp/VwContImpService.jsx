...
const API = "/vw_cont_imp";
export const fetchViewContImp = async (
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  const response = await axios.post(
    `${API}/list_of_cont_imp?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&language=${language}`,
    { filters: filters },
    {
      headers: {
...
export const fetchGroupFieldDropdown = async (
  ...
  const response = await axios.get(
    `${API}/dropdown_group_field?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&page=${page}&limit=${limit}&search=${search}`,
    {
      headers: {
        "ngrok-skip-browser-warning": "true",
      },
...
export const fetchInContDropdown = async (
  ...
  const response = await axios.get(
    `${API}/in_cont?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&field=${field}&page=${page}&limit=${limit}&search=${search}&mark=${mark}&vend_no=${vend_no}&d_type=${d_type}&is_status=${isStatus}`,
    {
      headers: {
        "ngrok-skip-browser-warning": "true",
      },
