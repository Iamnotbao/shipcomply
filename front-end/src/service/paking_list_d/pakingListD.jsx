...
const API = "/paking_list_d";
export const fetchAllListD = async (
 factory_code,
  department_code,
  user_code,
  query_level,
  ...
  const response = await axios.get(
    `${API}/all?factory_code=${factory_code}&department_code=${department_code}&user_code=${user_code}&query_level=${query_level}&language=${language}&org_id=${org_id}&se_id=${se_id}&se_ver=${se_ver}&se_seq=${se_seq}&pack_gu=${pack_gu}&ship_seq=${ship_seq}&limit=${limit}&offset=${offset}`,
    {
      headers: {
