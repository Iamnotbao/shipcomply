...
const acExpectMatDRepository = require("./ac_expect_matd.repository");

async function getAllAcExpectMatD(
  factory_code,
  expect_id,
  department_code,
  user_code,
  ...
  return await acExpectMatDRepository.listAllAcExpectMatD(
    factory_code,
    expect_id,
    department_code,
    user_code,
...
async function getAllAcChgMWithD(
  ...
  return await acExpectMatDRepository.listAllAcChgMWithDetails(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getFieldDropdown(factory_code, field, page, limit, search) {
  return await acExpectMatDRepository.fetchFieldDropdown(
    factory_code,
    field,
    page,
    limit,
...
async function getAcExpectMByID(factory_code, expect_id) {
  return await acExpectMatDRepository.getByID(factory_code, expect_id);
}
async function generateExpectId(factory_code) {
  return await acExpectMatDRepository.createExpectId(factory_code);
}
...
async function addAcExpectM(
  ...
  try {
    ...
    const result = await acExpectMatDRepository.add(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function editAcExpectM(
  ...
  try {
    ...
    const result = await acExpectMatDRepository.edit(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function deleteAcImp(factory_code, invoice_no, sort, t) {
  try {
    ...
    const result = await acExpectMatDRepository.deleteImp(existImp, t);
    if (!result) {
...
async function searchAcExpectM(
  ...
  try {
    const acImpFound = await acExpectMatDRepository.search(
      search,
      factory_code,
      department_code,
      user_code,
...
async function activateAcCM(
  ...
  return await acExpectMatDRepository.activate(
    factory_code,
    user_code,
    ac_no,
    curr_rate,
...
async function genOrderMaterial(factory_code, expect_id, user_code) {
  return await acExpectMatDRepository.generateOrderMaterial(
    factory_code,
    expect_id,
    user_code,
  );
...
async function calculateWriteoff(factory_code, expect_id, user_code) {
  return await acExpectMatDRepository.calculateWriteoffMaterial(
    factory_code,
    expect_id,
    user_code,
  );
...
async function reportShoeM(
  ...
  return await acExpectMatDRepository.reportShoeModel(
    factory_code,
    department_code,
    query_level,
    user_code,
...
async function reportWriteoff(
  ...
  return await acExpectMatDRepository.reportExpectWriteoff(
    factory_code,
    department_code,
    query_level,
    user_code,
