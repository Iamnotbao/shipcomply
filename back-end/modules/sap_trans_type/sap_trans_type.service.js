...
const sapTransTypeRepository = require("./sap_trans_type.repository");

async function getAllSTT(
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  return await sapTransTypeRepository.getListTransType(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getSPByID(factory_code, pay_no) {
  return await sapTransTypeRepository.getByID(factory_code, pay_no);
}
async function getFieldDropdown(factory_code, language, page, limit, search) {
  return await sapTransTypeRepository.fetchFieldDropdown(
    factory_code,
    language,
    page,
    limit,
...
async function addSP(
  ...
  try {
    ...
    const result = await sapTransTypeRepository.add(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function editSP(
  ...
  try {
    ...
    const result = await sapTransTypeRepository.edit(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function deleteABM(factory_code, prod_acno, item_acno, t) {
  try {
    ...
    const result = await sapTransTypeRepository.deleteABM(existABM, t);
    if (!result) {
...
async function searchABM(
  ...
  try {
    const acABMFound = await sapTransTypeRepository.search(
      keyword,
      factory_code,
      department_code,
      user_code,
