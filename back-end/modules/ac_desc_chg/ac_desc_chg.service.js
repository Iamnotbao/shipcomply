...
const acDescChgRepository = require("./ac_desc_chg.repository");

async function getAllAcDC(
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  return await acDescChgRepository.listAllAcDescChg(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getAcDescChgByID(factory_code, ac_no, seq) {
  return await acDescChgRepository.getByID(factory_code, ac_no, seq);
}
async function getSum(
  ...
  return await acDescChgRepository.fetchSumData(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getUnitByGoodsCode(
  ...
  return await acDescChgRepository.fetchUnitByGoodsCode(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function addAcDescChg(
  ...
  try {
    const result = await acDescChgRepository.add(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function editAcDescChg(
  ...
  try {
    const existAcCD = await getAcDescChgByID(factory_code, ac_no, seq);
    if (!existAcCD) {
      console.log("Import material tracking is not exist !");
      return null;
    }
    const result = await acDescChgRepository.edit(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function deleteAcImp(factory_code, invoice_no, sort, t) {
  try {
    ...
    const result = await acDescChgRepository.deleteImp(existImp, t);
    if (!result) {
...
async function searchAcImp(
  ...
  try {
    const acImpFound = await acDescChgRepository.search(
      keyword,
      factory_code,
      department_code,
      user_code,
