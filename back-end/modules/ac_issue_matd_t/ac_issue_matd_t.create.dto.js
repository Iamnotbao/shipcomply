...
const createAcIssueMatdTSchema = Joi.object({
  factory_code: Joi.string().max(30).required(),
  conf_seq: Joi.number().precision(2).required(),
  matd_seq: Joi.number().precision(2).allow(null).empty("").default(null).optional(),
  ...
  loss: Joi.number().precision(2).allow(null).empty("").default(null).optional(),
  req_qty: Joi.number().precision(8).allow(null).empty("").default(null).optional(),
  req_issue: Joi.string().max(1).valid("Y", "N").allow(null).empty("").default(null).optional(),
  issue_qty: Joi.number().precision(8).allow(null).empty("").default(null).optional(),
  remark: Joi.string().max(600).allow(null).empty("").default(null).optional(),
  col1: Joi.number().precision(4).allow(null).empty("").default(null).optional(),
  col2: Joi.number().precision(4).allow(null).empty("").default(null).optional(),
  col3: Joi.string().max(200).allow(null).empty("").default(null).optional(),
