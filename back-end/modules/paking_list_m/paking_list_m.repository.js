const SE_PAY = require("./paking_list_m.model.js");
const FACTORY = require("../factories/factory.model.js");
const { Op } = require("sequelize");
const pool = require("../../config/db.js");

async function listOfPakingListM(
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  try {
    ...
    console.error("Error fetching PAKING_LIST_M list:", error);
    throw error;
  }
}
      ...
      WHERE a.org_id = :factory_code
        ...
        AND (
          ...
          OR (a.se_id, a.se_seq) IN (
            ...
            JOIN "pac".sd_ord_m_c y ON x.factory_code = y.org_id AND x.se_id = y.se_id
