...
const acExpectMRepository = require("./ac_expect_m.repository");
...
async function getAllAcExpectM(
  factory_code,
  department_code,
  user_code,
  query_level,
  ...
  return await acExpectMRepository.listAllAcExpectM(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getAllAcChgMWithD(
  ...
  return await acExpectMRepository.listAllAcChgMWithDetails(
    factory_code,
    department_code,
    user_code,
    query_level,
...
async function getFieldDropdown(factory_code, field, page, limit, search) {
  return await acExpectMRepository.fetchFieldDropdown(
    factory_code,
    field,
    page,
    limit,
...
async function getAcExpectMByID(factory_code, expect_id) {
  return await acExpectMRepository.getByID(factory_code, expect_id);
}
async function generateExpectId(factory_code) {
  return await acExpectMRepository.createExpectId(factory_code);
}
...
async function addAcExpectM(
  ...
  try {
    ...
    const result = await acExpectMRepository.add(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function editAcExpectM(
  ...
  try {
    ...
    const result = await acExpectMRepository.edit(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function deleteAcImp(factory_code, invoice_no, sort, t) {
  try {
    ...
    const result = await acExpectMRepository.deleteImp(existImp, t);
    if (!result) {
...
async function searchAcExpectM(
  ...
  try {
    const acImpFound = await acExpectMRepository.search(
      search,
      factory_code,
      department_code,
      user_code,
...
async function activateAcCM(
  ...
  return await acExpectMRepository.activate(
    factory_code,
    user_code,
    ac_no,
    curr_rate,
...
async function genOrderMaterial(factory_code, expect_id, user_code) {
  return await acExpectMRepository.generateOrderMaterial(
    factory_code,
    expect_id,
    user_code,
  );
...
async function calculateWriteoff(factory_code, expect_id, user_code) {
  return await acExpectMRepository.calculateWriteoffMaterial(
    factory_code,
    expect_id,
    user_code,
  );
...
async function reportShoeM(
  ...
  return await acExpectMRepository.reportShoeModel(
    factory_code,
    department_code,
    query_level,
    user_code,
...
async function reportWriteoff(
  ...
  return await acExpectMRepository.reportExpectWriteoff(
    factory_code,
    department_code,
    query_level,
    user_code,
