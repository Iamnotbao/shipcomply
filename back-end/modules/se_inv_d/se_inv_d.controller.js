...
const createSeInvMSchema = require("./se_inv_d.create.dto");
const seInvMService = require("./se_inv_d.service");
...
async function getAllSeInvD(req, res) {
  const {
    factory_code,
    department_code,
    user_code,
  ...
  const result = await seInvMService.getAllSeInvD(
    factory_code,
    department_code,
    user_code,
    query_level,
