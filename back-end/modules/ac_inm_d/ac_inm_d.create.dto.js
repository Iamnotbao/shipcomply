...
const createAcInMDSchema = Joi.object({
  ...
  in_qty: Joi.number().allow(null).empty('').integer().optional(),
  in_money: Joi.number().integer().allow(null).empty('').optional(),
  hs_qty: Joi.number().integer().allow(null).empty('').optional(),
  n_qty: Joi.number().integer().allow(null).empty('').optional(),
