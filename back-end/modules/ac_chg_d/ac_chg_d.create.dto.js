...
const createAcChgDSchema = Joi.object({
  ...
  is_ref: Joi.string().max(2).allow(null).empty('').default(null).optional(),
  cmoney: Joi.number().precision(4).allow(null).empty('').default(null).optional(),
