...
const acPlanPackRepository = require("./ac_plan_pack.repository");

async function getListOfAPP(
 factory_code,
  department_code,
  user_code,
  query_level,
  ...
  return await acPlanPackRepository.getListOfAcPlanPack(
   factory_code,
  department_code,
  user_code,
  query_level,
...
async function getSPByID(factory_code, pay_no) {
  return await acPlanPackRepository.getByID(factory_code, pay_no);
}
async function getFieldDropdown(factory_code, language, page, limit, search) {
  return await acPlanPackRepository.fetchFieldDropdown(
    factory_code,
    language,
    page,
    limit,
...
async function addSP(
  ...
  try {
    ...
    const result = await acPlanPackRepository.add(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function editSP(
  ...
  try {
    ...
    const result = await acPlanPackRepository.edit(
      factory_code,
      department_code,
      user_code,
      query_level,
...
async function deleteABM(factory_code, prod_acno, item_acno, t) {
  try {
    ...
    const result = await acPlanPackRepository.deleteABM(existABM, t);
    if (!result) {
...
async function searchABM(
  ...
  try {
    const acABMFound = await acPlanPackRepository.search(
      keyword,
      factory_code,
      department_code,
      user_code,
